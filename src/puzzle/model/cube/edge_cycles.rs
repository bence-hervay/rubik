use super::{
    ...
    trace_facelet_location_through_moves, *,
};
impl EdgeThreeCycle {
...
pub(super) fn flip_right_edge_moves(n: usize) -> [Move; 7] {
    [
...
pub(super) fn unflip_right_edge_moves(n: usize) -> [Move; 7] {
    [
        face_layer_move(n, FaceId::R, 0, MoveAngle::Negative),
        face_layer_move(n, FaceId::F, 0, MoveAngle::Positive),
        face_layer_move(n, FaceId::R, 0, MoveAngle::Positive),
...
pub(super) fn move_sequence_updates(n: usize, moves: &[Move]) -> Option<Vec<FaceletUpdate>> {
    if n == 0 {
        return None;
    }
