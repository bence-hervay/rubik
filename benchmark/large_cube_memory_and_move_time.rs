...
const DEFAULT_RANDOM_MOVE_SIDE_LENGTH: usize = 1 << 14;
const DEFAULT_RANDOM_MOVE_COUNT: usize = 1000;
const DEFAULT_SLICE_MOVE_SIDE_LENGTH: usize = 1 << 16;
const DEFAULT_SLICE_MOVE_COUNT: usize = 1000;
